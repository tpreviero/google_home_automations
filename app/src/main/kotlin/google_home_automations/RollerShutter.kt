...
val tapparellaCameretta = RollerShutter(cameretta, "tapparella", setOf("sera", "est", "camere"), 20.seconds)
val tapparellaGrandeCamera = RollerShutter(camera, "tapparella grande", setOf("sera", "est", "camere"), 20.seconds)
